        ...
        <div className="container-page grid gap-12 py-20 md:grid-cols-[1.1fr_0.9fr] md:py-28">
          <div className="animate-fade-up">
            ...
            <p className="mt-6 max-w-xl text-lg text-white/70">
              Stop rebuilding risk assessments in Word and load plans in Excel for
            ...
            <div className="rounded-card bg-white text-ink shadow-lift">
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between rounded-lg border border-line px-3 py-2">
                  <span className="text-xs text-muted">18t Curtainsider · load</span>
                  <span className="font-mono text-sm">8,940 / 9,500 kg · 94%</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container-page">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {[
              ...
              ["Export & sign off", "Get a branded PDF with risk table, method statement and load plan. Ready to issue."],
            ].map(([title, body], i) => (
        ...
        <div className="container-page">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2">
            {[
              ...
              ["Load plan calculator", "Vehicle payload presets flag overloads before the truck does. Utilisation shown on the PDF."],
